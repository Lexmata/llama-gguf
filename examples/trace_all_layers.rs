...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let model_path = args
        .get(1)
        .map(|s| s.as_str())
        .unwrap_or("/home/joseph/Models/qwen2.5-0.5b-instruct-q4_k_m.gguf");
    ...
    eprintln!(
        "Config: hidden_size={}, num_layers={}, freq_base={}, freq_scale={}",
    ...
    for layer_idx in 0..num_layers {
        ...
        println!(
            "Layer {:2}: min={:9.4}, max={:9.4}, mean={:9.4}{}",
